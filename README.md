...
- Optimización web: SEO técnico, SEO on-page, React Helmet, Google Search Console, PageSpeed Insights 
...
- Análisis funcional: relevamiento de requerimientos, casos de uso, modelado UML, modelado de base de datos (Modelo relacional y Modelo Entidad-Relación).
